...
void _userSerialize(
  ...
  writer.writeBool(offsets[2], object.loggedIn);
...
User _userDeserialize(
  ...
  object.loggedIn = reader.readBoolOrNull(offsets[2]);
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> loggedInIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'loggedIn',
      ));
  ...
  QueryBuilder<User, User, QAfterFilterCondition> loggedInIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'loggedIn',
      ));
  ...
  QueryBuilder<User, User, QAfterFilterCondition> loggedInEqualTo(bool? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'loggedIn',
        value: value,
...
extension UserQuerySortBy on QueryBuilder<User, User, QSortBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> sortByLoggedIn() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'loggedIn', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByLoggedInDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQuerySortThenBy on QueryBuilder<User, User, QSortThenBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> thenByLoggedIn() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'loggedIn', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByLoggedInDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'loggedIn', Sort.desc);
    });
  }
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  ...
  QueryBuilder<User, User, QDistinct> distinctByLoggedIn() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, bool?, QQueryOperations> loggedInProperty() {
    return QueryBuilder.apply(this, (query) {
